...
class Client(object):
    ...
    @APIParamsCall
    def list_ext(self, resource_plural, path, retrieve_all=True, **_params):
        """Client extension hook for lists.
        """
        return self.list(resource_plural, path, retrieve_all, **_params)
    ...
    def extend_list(self, resource_plural, path):
        def _fx(retrieve_all=True, **_params):
            return self.list_ext(resource_plural, path, retrieve_all,
                                 **_params)
    ...
    def _register_extensions(self, version):
        for name, module in itertools.chain(
                client_extension._discover_via_contrib_path(version),
                client_extension._discover_via_python_path(),
